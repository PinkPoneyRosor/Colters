...
/*SF_DATA;ver:0.30;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,hqsc:True,hqlp:False,blpr:0,bsrc:0,bdst:0,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1,x:32094,y:32713|diff-4-RGB,spec-3-RGB,normal-2-RGB;n:type:ShaderForge.SFN_Tex2d,id:2,x:32563,y:32981,ptlb:Normal,ptin:_Normal,tex:5769febc5a57dc84baae3821636e3680,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:3,x:32563,y:32778,ptlb:Spec,ptin:_Spec,tex:74ff97678426eb548bc9e3966a032e77,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:4,x:32563,y:32590,ptlb:Diffuse,ptin:_Diffuse,tex:e04bfcc1e50cc8a4ca5ca0dc36bc49fb,ntxv:0,isnm:False;proporder:4-2-3;pass:END;sub:END;*/
...
/////// Normals:
                ...
                float3 normalLocal = tex2D(_Normal,TRANSFORM_TEX(node_10.rg, _Normal)).rgb;
...
////// Specular:
                NdotL = max(0.0, NdotL);
                float3 specularColor = tex2D(_Spec,TRANSFORM_TEX(node_10.rg, _Spec)).rgb;
...
/////// Normals:
                ...
                float3 normalLocal = tex2D(_Normal,TRANSFORM_TEX(node_11.rg, _Normal)).rgb;
                float3 normalDirection =  normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
...
////// Specular:
                ...
                float3 finalColor = 0;
                float3 diffuseLight = diffuse;
                finalColor += diffuseLight * tex2D(_Diffuse,TRANSFORM_TEX(node_11.rg, _Diffuse)).rgb;
                finalColor += specular;
/// Final Color:
