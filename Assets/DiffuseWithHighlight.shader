...
/*SF_DATA;ver:0.30;sub:START;pass:START;ps:flbk:,lico:1,lgpr:1,nrmq:1,limd:1,uamb:True,mssp:True,lmpd:False,lprd:False,enco:False,frtr:True,vitr:True,dbil:False,rmgx:True,hqsc:True,hqlp:False,blpr:0,bsrc:0,bdst:1,culm:0,dpts:2,wrdp:True,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5025951,fgcg:0.5924681,fgcb:0.6102941,fgca:1,fgde:0.02,fgrn:0,fgrf:300,ofsf:0,ofsu:0,f2p0:False;n:type:ShaderForge.SFN_Final,id:1,x:32350,y:32762|diff-2-RGB,spec-3-RGB,normal-4-RGB,emission-40-OUT;n:type:ShaderForge.SFN_Tex2d,id:2,x:33051,y:32620,ptlb:diffuse,ptin:_diffuse,ntxv:0,isnm:False|UVIN-10-UVOUT;n:type:ShaderForge.SFN_Tex2d,id:3,x:33058,y:32829,ptlb:spec,ptin:_spec,ntxv:0,isnm:False|UVIN-11-UVOUT;n:type:ShaderForge.SFN_Tex2d,id:4,x:32712,y:32802,ptlb:nrml,ptin:_nrml,ntxv:3,isnm:False|UVIN-12-UVOUT;n:type:ShaderForge.SFN_TexCoord,id:10,x:33244,y:32586,uv:1;n:type:ShaderForge.SFN_TexCoord,id:11,x:33251,y:32833,uv:1;n:type:ShaderForge.SFN_TexCoord,id:12,x:33280,y:33077,uv:1;n:type:ShaderForge.SFN_Lerp,id:40,x:32597,y:32986|A-41-OUT,B-42-OUT,T-46-OUT;n:type:ShaderForge.SFN_Multiply,id:41,x:32777,y:32967|A-44-OUT,B-47-RGB;n:type:ShaderForge.SFN_Vector1,id:42,x:32777,y:33195,v1:0;n:type:ShaderForge.SFN_Fresnel,id:44,x:33214,y:33255|EXP-45-OUT;n:type:ShaderForge.SFN_Slider,id:45,x:33373,y:33255,ptlb:Highlight_Width,ptin:_Highlight_Width,min:0,cur:1.255639,max:5;n:type:ShaderForge.SFN_Slider,id:46,x:32722,y:33289,ptlb:Highlight_Intensity,ptin:_Highlight_Intensity,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Color,id:47,x:33077,y:33286,ptlb:Highlight_Color,ptin:_Highlight_Color,glob:False,c1:0.5,c2:0.5,c3:1,c4:1;proporder:2-3-4-45-46-47;pass:END;sub:END;*/

Shader "Custom/diffuse_NRM_SPECWithHighlight" {
    Properties {
        _diffuse ("diffuse", 2D) = "white" {}
        _spec ("spec", 2D) = "white" {}
        _nrml ("nrml", 2D) = "bump" {}
        _Highlight_Width ("Highlight_Width", Range(0, 5)) = 1.255639
        _Highlight_Intensity ("Highlight_Intensity", Range(0, 1)) = 0
        _Highlight_Color ("Highlight_Color", Color) = (0.5,0.5,1,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            uniform float _Highlight_Width;
...
////// Emissive:
                float node_42 = 0.0;
                float3 emissive = lerp((pow(1.0-max(0,dot(normalDirection, viewDirection)),_Highlight_Width)*_Highlight_Color.rgb),float3(node_42,node_42,node_42),_Highlight_Intensity);
///////// Gloss:
